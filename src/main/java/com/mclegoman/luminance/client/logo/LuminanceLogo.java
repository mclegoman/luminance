...
public class LuminanceLogo {
	...
	public static class Widget extends AbstractWidget {
		...
		public void renderWidget(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
			renderLogo(guiGraphics, this.getX(), this.getY(), this.getWidth(), this.getHeight(), isPride);
			if (shouldRenderSplashText) LogoHelper.createSplashText(guiGraphics, this.getWidth(), this.getX(), this.getY() + 32, ClientData.minecraft.font, splashText, -20.0F);
		}
		@Override
