...
public class ShaderDataloader extends JsonDataLoader implements IdentifiableResourceReloadListener {
	...
	public void apply(Map<Identifier, JsonElement> prepared, ResourceManager manager, Profiler profiler) {
		...
		if (ClientData.isDevelopment) {
			...
			Events.ShaderRender.modify(Identifier.of(Data.version.getID(), "debug"), List.of(new Shader.Data(Identifier.of(Data.version.getID(), "debug"), new Shader(Shaders.get(Identifier.of("minecraft", "wobble")), () -> Debug.debugRenderType, () -> Debug.debugShader))));
